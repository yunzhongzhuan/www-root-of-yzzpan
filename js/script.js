	...
	*/
	...
	for(let i=0;i<files_items.length;i++){
		...
		div.menu_download_element.onclick = function(){
			...
			html_element.innerHTML = "<p><a href='" + download_web_url + this.parent.url + "' target='iframe-for-download'>电信下载</a></p><p><a href='https://cdn-download.yunzhongzhuan.xyz" + this.parent.url + "' target='iframe-for-download'>移动下载</a></p><p><a href='https://ddos-guard-net-download.yunzhongzhuan.com" + this.parent.url + "' target='iframe-for-download'>联通下载</a></p><p><a href='https://download.yunzhongzhuan.eu.org" + this.parent.url + "' target='iframe-for-download'>备用下载</a></p><p><a href='https://download.yantudefengjing.eu.org" + this.parent.url + "' target='iframe-for-download'>备用下载</a></p>";
...
files_main.oncontextmenu=function(e){
	...
	if( folders_items_selected_array.length == 0 && files_items_selected_array.length == 1 ){
		...
		files_download_button.onclick = function(){
			let html_element = document.createElement('div');
			html_element.innerHTML = "<p><a href='" + download_web_url + files_items_selected_array[0].url + "' target='iframe-for-download'>电信下载</a></p><p><a href='https://cdn-download.yunzhongzhuan.xyz" + files_items_selected_array[0].url + "' target='iframe-for-download'>移动下载</a></p><p><a href='https://ddos-guard-net-download.yunzhongzhuan.com" + files_items_selected_array[0].url + "' target='iframe-for-download'>联通下载</a></p><p><a href='https://download.yunzhongzhuan.eu.org" + files_items_selected_array[0].url + "' target='iframe-for-download'>备用下载</a></p><p><a href='https://download.yantudefengjing.eu.org" + files_items_selected_array[0].url + "' target='iframe-for-download'>备用下载</a></p>";
